    ...
    <div className="fixed inset-x-0 top-0 z-[5]">
      ...
      <div className="my-container flex items-stretch justify-between bg-background md:bg-transparent">
        ...
        <div className="curve flex h-auto w-auto items-center justify-center rounded-bl bg-background px-4 text-5xl before:-left-[40px] before:top-0 before:size-[40px] before:rotate-90 after:-bottom-[40px] after:right-0 after:size-[40px] after:rotate-90">
          ...
          <FaHamburger className="rounded-full bg-background p-2 text-primary transition-all hover:cursor-pointer hover:bg-primary hover:text-background active:bg-primary/80 active:text-background md:hidden" />
        </div>
      </div>
    </div>
  );
